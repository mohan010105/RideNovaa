...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(false);
    if (result.success) { toast.success('Account created! Please check your email to verify.'); navigate('/login'); }
    else toast.error(result.error || 'Email already exists');
  };
    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardDescription>Join CabRide for quick & easy rides</CardDescription>
        </CardHeader>
